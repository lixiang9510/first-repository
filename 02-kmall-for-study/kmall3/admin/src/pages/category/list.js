...
const mapDispatchToProps = (dispath)=>{
    return {
        ...
        handleOrder:(pid,id,newOrder)=>{
          const action = actionCreator.getPageAction(pid,id,newOrder)
          dispath(action)
        },
        showUpdateNameModal:(updateId,updateName)=>{
          const action = actionCreator.getPageAction(updateId,updateName)
          dispath(action)
        },
        closeUpdateNameModal:(updateId,updateName)=>{
          const action = actionCreator.getPageAction(updateId,updateName)
          dispath(action)
        },
        handleUpdateNameChange:(value)=>{
          const action = actionCreator.getPageAction(value)
          dispath(action)
        }
    }
}
